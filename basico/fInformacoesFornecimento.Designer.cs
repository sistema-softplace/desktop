...
namespace basico
{
	partial class fInformacoesFornecimento
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			// 
			// fInformacoesFornecimento
			// 
			this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 13F);
			this.AutoScaleMode = System.Windows.Forms.AutoScaleMode.Font;
			this.ClientSize = new System.Drawing.Size(624, 490);
			this.Name = "fInformacoesFornecimento";
			this.Text = "Informações de Fornecimento";
			this.Load += new System.EventHandler(this.fInformacoesFornecimentoLoad);

...
namespace basico
{
	partial class frmCadOrigens
	{
		...
		private void InitializeComponent()
		{
			...
			this.ckbAtiva.Location = new System.Drawing.Point(61, 90);
			...
			this.Name = "frmCadOrigens";
			this.Text = "Ações Comerciais - Origens";
			this.Load += new System.EventHandler(this.FrmCadOrigensLoad);

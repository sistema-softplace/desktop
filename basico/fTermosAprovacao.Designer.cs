...
namespace basico
{
	partial class fTermosAprovacao
	{
		/// <summary>
		...
		private void InitializeComponent()
		{
			...
			this.Name = "fTermosAprovacao";
			this.Text = "Termos de Aprovação e Aceite";
			this.Load += new System.EventHandler(this.fTermosAprovacaoLoad);
